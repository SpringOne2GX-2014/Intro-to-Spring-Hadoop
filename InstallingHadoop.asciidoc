...
Install a basic VM with 4GB of memory and 40GB of disk space if you have this available. Create a 'hadoop' user as part of the install. The 'hadoop' user will be the owner of all Hadoop software that we install later.
